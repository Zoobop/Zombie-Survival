...
AEntity::AEntity()
{
	...
	EntityStatComponent = CreateDefaultSubobject<UEntityStatComponent>("EntityStatComponent");
}

class UEntityStatComponent* AEntity::GetEntityStatComponent()
{
...
void AEntity::ReplicatePitchAndYaw_Implementation()
{
	FRotator Rotator = (GetControlRotation() - GetActorRotation()).GetNormalized();
	Yaw = Rotator.Yaw;
	Pitch = Rotator.Pitch;
}
